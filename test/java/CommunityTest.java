...
public class Main {
    ...
    @Test(priority = 5) public void deletingCommunity() throws InterruptedException {
        ...
        // Deletes Community
        driver.findElement(By.xpath("/html/body/div[1]/div/div/div[3]/div/div[4]/div/header/div[3]/div/div[2]/div/button/span")).click();
        Thread.sleep(2000);
        driver.findElement(By.xpath("/html/body/div[1]/div/div/span[5]/div/ul/div/div/li[6]/div")).click();
        Thread.sleep(2000);
        driver.findElement(By.xpath("/html/body/div[1]/div/div/span[2]/div/div/div/div/div/div/div[2]/div/button[2]")).click();
        Thread.sleep(2000);
    }
