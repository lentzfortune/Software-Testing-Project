...
public class ContactTest {
    ...
    @Test(priority = 2) public void mediaView() throws InterruptedException {
        ...
        // hit contact info
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/span[5]/div/ul/div/div/li[1]")).click();
        Thread.sleep(2000);
    ...
    @Test(priority = 3) public void downloadMedia() throws InterruptedException {
        ...
        // Upload the photo
        fileInput.sendKeys("C:\\Users\\jorda\\OneDrive - Florida Gulf Coast University\\Projects\\intellij\\WhatsApp-Testing\\chicken_jockey.jpg");
        Thread.sleep(2000);
